...
fundingAccount = BankAccount(0.01,1000)
savingAccount = BankAccount(0.05,5000)

fundingAccount.display_account_info().deposit(200).deposit(100).deposit(50).withdraw(88).display_account_info()
savingAccount.display_account_info().yield_interest().display_account_info()
